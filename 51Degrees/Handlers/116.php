...
function _H116($useragent) {
  ...
  $ua = 'curl/7.18.2 (Jappy-Link-Checker; http://www.jappy.de/infos/linkChecker)';
  $ns = E116($useragent, $ua, $ls);
  if ($ns <= $ls) {
    if ($ns < $ls) {
      unset($dl);
  ...
  $ua = 'curl/7.21.7 (x86_64-redhat-linux-gnu) libcurl/7.21.7 OpenSSL/0.9.8b zlib/1.2.3 libidn/0.6.5 libssh2/1.2.7';
  $ns = E116($useragent, $ua, $ls);
  if ($ns <= $ls) {
    if ($ns < $ls) {
      unset($dl);
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(53173,293497,16074,913, $ua, '15364-17350-17470-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(53173,600201,16074,913, $ua, '15364-18575-17470-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(297934,142808,16074,913, $ua, '18254-18110-17470-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(53173,905363,16074,913, $ua, '15364-22471-17470-18092');
  }
  ...
  if ($ns <= $ls) {
    ...
    $dl[] = array(53173,787494,16074,913, $ua, '15364-22473-17470-18092');
  }
  ...
  $ua = 'curl/7.20.0 (i386-apple-darwin9.8.0) libcurl/7.20.0 OpenSSL/0.9.8m zlib/1.2.3 libidn/1.16';
  $ns = E116($useragent, $ua, $ls);
  if ($ns <= $ls) {
    if ($ns < $ls) {
      unset($dl);
    ...
    $dl[] = array(53173,707712,16074,913, $ua, '15364-22475-17470-18092');
  }
  return $dl;
}
